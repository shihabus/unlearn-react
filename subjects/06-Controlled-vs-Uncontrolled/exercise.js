...
class CheckoutForm extends React.Component {
  ...
  changeHandlers = (e) => this.setState({ [e.target.name]: e.target.value })
      ...
      <div>
        ...
        <form>
          <fieldset>
            ...
            <p>
              <label>
                Billing Name: <input type="text" name='billingName' onChange={this.changeHandlers} />
              </label>
            </p>
            <p>
              <label>
                Billing State: <input type="text" size="2" name='billingState' onChange={this.changeHandlers} />
              </label>
            </p>
          </fieldset>
          ...
          <fieldset>
            <label>
              <input type="checkbox" onChange={this.changeHandlers} name='isChecked' /> Same as billing
            </label>
